export default function Button(props) {
    const variants = {
        ...
        outline: 'border border-gray-300 dark:border-gray-5 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500',
    ...
    return (
        <button {...props} className={`${props.variant ? variants[props.variant] : variants['default']} 
